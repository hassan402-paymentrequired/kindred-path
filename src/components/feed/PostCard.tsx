                    ...
                    >
                      {isVideo ? (
                        ...
                        <img 
                          src={url} 
                          alt="Post media" 
                          className="w-full h-48 object-cover rounded-xl group-hover:opacity-90 transition-opacity"
                        />
                      )}
                    </div>
                  );
      ...
      {showMediaModal && post.media && (
        ...
        >
          <div className="max-w-4xl max-h-[90vh] w-full">
            {post.media[activeMediaIndex].includes('.mp4') || 
             post.media[activeMediaIndex].includes('.webm') || 
             post.media[activeMediaIndex].includes('.mov') ? (
              <video 
