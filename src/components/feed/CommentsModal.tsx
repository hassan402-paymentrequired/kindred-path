...
import { Post, mockComments, Comment } from '@/data/mockData';
      ...
      <div className="relative w-full max-w-lg bg-card border-t border-x border-border rounded-t-3xl shadow-elevated animate-slide-up max-h-[85vh] flex flex-col">
        ...
        <div className="px-4 py-3 border-b border-border bg-muted/30">
          <div className="flex gap-3">
            <div className="w-8 h-8 rounded-full bg-card border border-border flex items-center justify-center text-lg">
              {post.avatar}
            </div>
            ...
            comments.map((comment) => {
              ...
              return (
                <div key={comment.id} className="flex gap-3 animate-slide-up">
                  <div className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center text-xl flex-shrink-0">
                    {comment.avatar}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        className={cn(
                          ...
                          isLiked ? "text-love" : "text-muted-foreground hover:text-love"
                        )}
                      >
                      ...
                      <button className="text-xs text-muted-foreground hover:text-success transition-colors">
                        Support 💚
                      </button>
                    </div>
                  </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 relative">
              <input
                ...
                className="w-full bg-muted border border-border rounded-full py-2.5 px-4 pr-12 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              />
              <Button
                type="submit"
                variant="ghost"
                ...
                className="absolute right-1 top-1/2 -translate-y-1/2 text-primary disabled:text-muted-foreground"
              >
